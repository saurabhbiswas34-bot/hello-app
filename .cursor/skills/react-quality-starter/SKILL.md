...
| **Component addition**              | User asks to create reusable UI piece (`Card`, `Navbar`, `AccordionList`).                                                  | Place by Atomic layer under `src/components`, co-locate CSS/tests, keep props typed, avoid feature logic leakage. |
